    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-perms="'coupon:homesubjectspu:delete'"
        >
          批量删除
        </el-button>
      </el-form-item>
      ...
      >
        <template #default="scope">
          <el-button
            ...
            v-perms="'coupon:homesubjectspu:update'"
          >
            修改
          </el-button>
          <el-button
...
import {
  reqHomeSubjectSpuDelete,
  reqHomeSubjectSpuList,
...
const getDataList = async () => {
  ...
  try {
    const response = await reqHomeSubjectSpuList(
      pageIndex.value,
      pageSize.value,
      dataForm.value.key,
    )
...
const deleteHandle = async (id?: number) => {
  ...
  try {
    ...
    const response = await reqHomeSubjectSpuDelete(ids)
    if (response && response.code === 200) {
      ElMessage({
        type: 'success',
        message: 'spu专题删除成功',
